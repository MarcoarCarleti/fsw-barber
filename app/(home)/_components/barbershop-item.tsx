...
const BarbershopItem = ({ barbershop }: BarbershopItemProps) => {
  ...
  return (
    <Card className="min-w-full max-w-full min-h-full max-h-full rounded-2xl">
      <CardContent className="px-1 py-0 pt-1">
        ...
        </div>  <div className="px-2 pb-3 min-h-[165px] max-h-[165px] flex flex-col justify-between">
